                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h3 text-gray-900 mb-4">Tambah Ruangan Baru</h1>
                                    </div>
                                    <hr>
                                    <form action="simpan-ruangan.php" method="POST" class="ruangan">   
                                        <div class="form-group mb-3">
                                            <label for="nama_ruangan">Nama Ruangan:</label><br>
                                            <input type="text" id="nama_ruangan" name= "nama_ruangan" required><br>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="fungsi">Fungsi Ruangan:</label>
                                            <br>
                                            <input type="text" id="fungsi" name="fungsi"><br>                                                
                                        </div>
                                        <div class="grid-cols-2">
                                            <div class="col-span-1 form-group mb-3 ">
                                                <label for="lantai">Lantai*:</label>
                                                    <select  class="custom-select" id="lantai" name="lantai" require>
                                            ...
                                            <div class="col-span-2 form-group mb-3">
                                                <label for="arah">Arah Ruangan:</label>
                                                <br>
                                                <select  class="custom-select width=6" id="arah" name="arah">
                                                    <option value='<?php NULL ?>'>Arah</option>
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="luas">Luas Ruangan: (m<sup>2</sup>):</label>
                                            <br>
                                            <input type="number" id="luas" name="luas"><br>
                                        </div>
                                        
                                        <div class="form-group mb-3">
                                            <label for="kapasitas">Kapasitas Ruangan*: (orang)</label>
                                            <br>
                                            <input type="number" id="kapasitas" name="kapasitas" required><br>                                                
                                        </div>
                                        
                                        <p class='text-red-500'>*Harus di isi</p>        
